...
public class C05_Set {
    public static void main(String[] args) {
        ...
        System.out.println(ogrenciler);//[Ayten, Esra, Furkan]  natural ordinal oldu

        ogrenciler.add("Ahmet");
        System.out.println(ogrenciler);//[Ahmet, Ayten, Esra, Furkan]
        ogrenciler.add("Furkan");
        System.out.println(ogrenciler);//[Ahmet, Ayten, Esra, Furkan] eski furkani siler yerine yenisini ekler
