...
public class C01_NestedOgrenciMap {
    public static void main(String[] args) {
        ...
        ogrenciMap.put(102,ogrenci101);
        ogrenciMap.put(103,ogrenci101);

        System.out.println(ogrenciMap);
/*
{101={Bolum=MF, Soyisim=Can, Sube=H, Sinif=11, Isim=Ali},
102={Bolum=MF, Soyisim=Can, Sube=H, Sinif=11, Isim=Ali},
 103={Bolum=MF, Soyisim=Can, Sube=H, Sinif=11, Isim=Ali}}
 */

        //101 numarali ogrencinin ismini yazdiralim
        System.out.println(ogrenciMap.get(101).get("Isim"));//Ali

        //102 numrali ogrencinin sinif bilgisini yazdirin

        System.out.println(ogrenciMap.get(102).get("Sinif"));//11
