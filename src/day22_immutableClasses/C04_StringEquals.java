...
public class C04_StringEquals {
    public static void main(String[] args) {
        ...
        eger String olusturulurken bugune kadar yaptigimiz gibi basit bir sekilde olustururulursa
        havuzu kontrol edr ve ayni deger varsa bunlari ozdeslestirir
        Ancak new keyword kulllanilir veya bir islem sonucunda String elde edilecek olursa
        ...
        System.out.println(str6.equals("Java"));
        System.out.println("-------------------");
