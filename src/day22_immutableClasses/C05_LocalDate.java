...
public class C05_LocalDate {
    public static void main(String[] args) {
        ...
        System.out.println(tarih.minusWeeks(5));//2022-11-14 // 5 hafta once bugun
        System.out.println(tarih.minusYears(3).minusMonths(5).minusDays(5));
        //2019-07-14

        System.out.println(tarih.plusWeeks(19));//2023-05-01 19 hafta sonra bugun
        ...
        System.out.println(tarih.hashCode());//4141843 referans bilgisi gibi javanin veridigi bir kod
